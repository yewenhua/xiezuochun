...
public class XEditText extends AppCompatEditText {
    ...
    private void dealWithInputTypes(boolean fromXml) {
        ...
        if (isPwdInputType) {
            ...
            if (mShowPwdResId == -1) {
                mShowPwdResId = R.drawable.iv_hide_pwd;
            }
            if (mHidePwdResId == -1) {
                mHidePwdResId = R.drawable.iv_show_pwd;
            }
            ...
            if (mTogglePwdDrawable != null) {
                if (mShowPwdResId == R.drawable.iv_hide_pwd ||
                        mHidePwdResId == R.drawable.iv_show_pwd) {
            ...
            if (!disableClear) {
                mBitmap = getBitmapFromVectorDrawable(getContext(), mClearResId,
                        mClearResId == R.drawable.iv_clear); // clearDrawable
            }
        }
